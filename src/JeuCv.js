  ...
  jeuBreaker = function () {
    ...
    function varsStart() {
      ...
      window.document.getElementById("linkedIn").style.left =
        competences.offsetWidth / 2 - 40 + "px"
      linkedIn.style.top =
        competences.offsetTop + competences.offsetHeight - 60 + "px"
      ...
      var paddle = function () {
        ...
        //Right paddle side
          ...
          ballX + divSprite.offsetWidth / 2 > linkedIn.offsetLeft &&
          ballX + divSprite.offsetWidth / 2 <
            linkedIn.offsetLeft + linkedIn.offsetWidth + 5
        ) {
          ballDown = false
          ballLeft = false
          combo += 1
      ...
      var deplacerBalle = function () {
        ...
        if (ballY >= competences.offsetTop && !ballDown) {
          ...
          divSprite.style.top = ballY + "px"
          if (
            ballY + divSprite.offsetHeight > linkedIn.offsetTop &&
            ballY < linkedIn.offsetTop + 5
          )
            paddle()
        } else {
          ballDown = false
    ...
    return (
      <section id="JeuCv">
        ...
        <div className="competen" id="competen">
          ...
          <div className="informatiquesCont french english spanish">
            ...
            <div className="informatiques" id="informatique">
              ...
              <div className="infoJeu">Bootstrap</div>
              <div className="infoJeu">jade/PUG</div>
              <div className="infoJeu">w3c DOM</div>
              <div className="infoJeu">SCSS</div>
              <div className="infoJeu">Jquery</div>
              <div className="infoJeu">ES6</div>
              <div className="infoJeu">IBM dspf</div>
              <div className="infoJeu">IBM prtf</div>
            </div>
            <h3>Back End</h3>
            <div className="informatiques" id="informatique">
              <div className="infoJeu">IBM i</div>
              <div className="infoJeu">IBM RPG IV</div>
              <div className="infoJeu">IBM CLP</div>
              <div className="infoJeu">IBM db2</div>
              <div className="infoJeu">IBM QSH</div>
              <div className="infoJeu">NextJS</div>
              <div className="infoJeu">NodeJS</div>
              <div className="infoJeu">ExpressJS</div>
              <div className="infoJeu">MongoDB</div>
            ...
            <div className="informatiquesLast" id="informatique">
              ...
              <div className="infoJeu">IBM ACS</div>
              <div className="infoJeu">ARCAD for i</div>
              <div className="infoJeu">ADELIA for i</div>
              <div className="infoJeu">IBM DPA</div>
          ...
          <div className="btp french english spanish" id="btp">
            ...
            <div className="infolast french">
              Réaliser un dossier de détails d'exécutions de projet (Autocad,
              VectorWorks)
            </div>
          ...
          <div
            className="commerciales french english spanish"
            id="commerciales"
          >
            <h3>H to H</h3>
            <div className="info french">
              Assistant régie au Palais des Festivals de Cannes en productions
              télévisuelles
            </div>
            <div className="info english">
        ...
        <div className="competen" id="experiences">
          ...
          <div className="jobs">
            <h3 className="french">Analyste Programmeur IBM i</h3>
            <h3 className="english">IBM i developer</h3>
            <div className="infojob french">
              Développement du programme d'anonymisation des données
              personnelles sur ibm db2 en ADELIA/SQL
            </div>
            <div className="infojob english">
              IBM i Developer (QSH, CLP, SQL, RPG III, Adelia, Rdi)
            </div>
            <div className="infojob spanish">
              IBM i Developer (QSH, CLP, SQL, RPG III, Adelia, Rdi)
            </div>
            <div className="lieu">Depuis le 25/11/2020: Guarani, Bordeaux</div>
          </div>
          <div className="jobs">
            <h3 className="french">Analyste Programmeur IBM i</h3>
            <h3 className="english">IBM i software engineer</h3>
            <div className="infojob french">
              Développement sur IBM i (QSH, CL, CLP, SQLRGPLE, RPG III, Arcad,
              Rdi)
            </div>
            <div className="infojob english">
          ...
          <div className="jobs">
            <h3>Webmaster</h3>
            <div className="infojob french">
              Mise &agrave; jour de la base de données site Ecommerce (magento)
            </div>
            <div className="infojob english">
          ...
          <div className="jobs">
            ...
            <div className="lieu">12/2007 =&gt; 04/2008: l'Alpe d'Huez</div>
          </div>
          <div className="jobs">
          ...
          <div className="jobs">
            ...
            <div className="infojob french">
              ...
              Ouvrier boulanger, Employé polyvalent chez Intermarché
            </div>
        ...
        <div className="competen" id="formation">
          ...
          <div className="jobs">
            <h3>Pepiniere IBM</h3>
            <div className="infojob french">IBM RPG III, RPGLE, SQL, CLP</div>
            <div className="infojob english">IBM RPG III, RPGLE, SQL, CLP</div>
            <div className="infojob spanish">RPG III, RPGLE, SQL, CLP</div>
          ...
          <div className="jobs">
            ...
            <div className="infojob french">
              Administration et déploiementent réseau en environnement Linux,
              cli, regexp
              <br />
            ...
            <div className="infojob spanish">
              ...
              sistemas en entorno Linux, nociones de ensamblador regexp Base de
              Datos: Análisis (merise), diseño (MCD, MCT), mantenimiento
          ...
          <div className="jobs">
            ...
            <div className="infojob french">Spécialité physique-chimie</div>
        ...
        <div className="competen" id="complementaire">
          ...
          <div className="infojob spanish">
            Permiso: auto, motocicleta. Deporte: gimnasio, deportes de tabla,
            ciclismo de montaña. Hobbies: electrónica, decoración, diseño,
            renovación.
          </div>
        </div>
      </section>
